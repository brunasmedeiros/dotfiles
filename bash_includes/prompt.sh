...
then
  ...
  then
    ...
    echo "WARNING: Could not find git"
    echo "git related command prompt information will not be present"
    echo
  fi
fi
...
function __prompt_command() {
  ...
  # Add the host and the full path to the current working directory
